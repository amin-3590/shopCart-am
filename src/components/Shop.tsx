        ...
        const fetchProducts = async () => {
            ...
            try {
                ...
                const query = ` *[_type == 'product' 
                                ...
                                && price >= $minPrice && price <= $maxPrice] | order(name asc) {...,"categories": categories[]->title}`;
                ...
                <div className="sticky top-0 z-10 mb-5">
                    <div className="flex items-center justify-between">
                        ...
                        {(selectedCategory !== null || selectedBrand !== null || selectedPrice !== null) && (
                            ...
                            }} className="text-shop_dark_green underline text-sm mt-2 font-medium hover:text-darkRed transition-all duration-300 ease-in-out">
                                Reset Filters
                            </button>
                        )}
