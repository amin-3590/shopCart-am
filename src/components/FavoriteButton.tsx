    ...
    return (
        <>
            {!showProduct ? (
                ...
                <button onClick={handleFavorite} className="group relative hover:text-shop_light_green transition-all duration-300 ease-in-out border border-shop_light_green/80 hover:border-shop_light_green p-1.5 rounded-sm">
                    {existingProduct ? (
                        <Heart
                            fill="#3b9c3c"
                            className="text-shop_light_green/80 group-hover:text-shop_light_green transition-all duration-300 ease-in-out mt-.5 w-5 h-5"
                        />
                    ) : (
