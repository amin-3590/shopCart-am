                                                        ...
                                                        {product.images && (
                                                            <Link href={`/product/${product.slug?.current}`} className="border p-0.5 md:p-1 mr-2 rounded-md overflow-hidden group">
                                                                <Image
                                                                    ...
                                                                    loading="lazy"
                                                                    unoptimized
                                                                    className="w-32 md:w-40 h-32 md:h-40 object-cover group-hover:scale-105 transition-all duration-300 ease-in-out"
                                                                />
                                                            </Link>
                                                        )}
                                                                    ...
                                                                    <Tooltip>
                                                                        <TooltipTrigger>
                                                                            <Trash onClick={() => {
                                                                                ...
                                                                                className="w-4 h-4 md:w-5 md:h-5 mr-1 text-gray-500 hover:text-red-600 transition-all duration-300 ease-in-out"
                                                                            />
                                                                        </TooltipTrigger>
