                    ...
                    <div>
                        <div className="text-xs flex items-center gap-5 my-7">
                            <div className="flex items-center relative group cursor-pointer">
                                ...
                                <span className="absolute left-0 -bottom-1.5 bg-lightColor/30 inline-block w-full h-[2px] group-hover:bg-shop_dark_green hover:cursor-pointer transition-all duration-300 ease-in-out" />
                            </div>

                            <p className="flex items-center gap-1 text-lightColor relative group hover:cursor-pointer hover:text-shop_dark_green transition-all duration-300 ease-in-out">
                                <Pencil size={15} /> {blog.author?.name}
                                <span className="absolute left-0 -bottom-1.5 bg-lightColor/30 inline-block w-full h-[2px] group-hover:bg-shop_dark_green transition-all duration-300 ease-in-out" />
                            </p>
        ...
        <div>
            <div className="border border-lightColor p-5 rounded-md">
                ...
                <div className="space-y-2 mt-2">
                    {categories.map(({ blogcategories }, index: number) => (
                        ...
                        <Link href={`/blog/${blog.slug?.current}`} key={index} className="flex items-center gap-2 group" >
                            ...
                            {blog.mainImage && (
                                <Image
                                    ...
                                    width={100}
                                    height={100}
                                    className="w-16 h-16 rounded-full object-cover border-[1px] border-shop_dark_green/10 group-hover:border-shop_dark_green transition-all duration-300 ease-in-out"
                                />
                            )}

                            <p className="line-clamp-2 text-sm text-lightColor group-hover:text-shop_dark_green transition-all duration-300 ease-in-out">
                                {blog.title}
                            </p>
                        </Link>
                    ))}
